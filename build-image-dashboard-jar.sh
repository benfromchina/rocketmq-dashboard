...
case "${BASE_IMAGE}" in
    centos)
        docker build --no-cache -f Dockerfile-centos-dashboard-jar -t apache/rocketmq-dashboard:${ROCKETMQ_DASHBOARD_VERSION} --build-arg version=${ROCKETMQ_DASHBOARD_VERSION} .
    ;;
    *)
